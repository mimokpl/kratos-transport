module github.com/mimokpl/kratos-transport/_example/server/websocket
...
replace (
	...
	github.com/mimokpl/kratos-transport/transport/websocket => ../../../transport/websocket
)

require (
	github.com/go-kratos/kratos/v2 v2.9.2
	github.com/mimokpl/kratos-transport/transport/websocket v1.9.0
)
...
require (
	...
	github.com/mimokpl/go-utils/id v1.9.0 // indirect
