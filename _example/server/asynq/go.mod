module github.com/mimokpl/kratos-transport/_example/server/asynq
...
replace (
	...
	github.com/mimokpl/kratos-transport/transport/asynq => ../../../transport/asynq
)

require (
	github.com/go-kratos/kratos/v2 v2.9.2
	github.com/hibiken/asynq v0.26.0
	github.com/mimokpl/kratos-transport/transport/asynq v1.3.2
)
