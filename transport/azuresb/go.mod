module github.com/mimokpl/kratos-transport/transport/azuresb

go 1.25.0

replace (
	github.com/mimokpl/kratos-transport/broker => ../../broker
	github.com/mimokpl/kratos-transport/broker/azuresb => ../../broker/azuresb
...
require (
	...
	github.com/mimokpl/kratos-transport/broker/azuresb v1.1.1
	github.com/mimokpl/kratos-transport/transport v1.1.1
	github.com/mimokpl/kratos-transport/transport/keepalive v1.1.1
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/messaging/azservicebus v1.8.1 // indirect
