module github.com/mimokpl/kratos-transport/transport/activemq

go 1.25.0

replace (
	github.com/mimokpl/kratos-transport/broker => ../../broker
	github.com/mimokpl/kratos-transport/broker/stomp => ../../broker/stomp
...
require (
	...
	github.com/mimokpl/kratos-transport/broker/stomp v1.1.1
