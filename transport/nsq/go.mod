module github.com/mimokpl/kratos-transport/transport/nsq

go 1.25.0

replace (
	github.com/mimokpl/kratos-transport/broker => ../../broker
	github.com/mimokpl/kratos-transport/broker/nsq => ../../broker/nsq
...
require (
	...
	github.com/mimokpl/kratos-transport/broker/nsq v1.3.3
