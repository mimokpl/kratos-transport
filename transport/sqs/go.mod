module github.com/mimokpl/kratos-transport/transport/sqs

go 1.25.0

replace (
	github.com/mimokpl/kratos-transport/broker => ../../broker
	github.com/mimokpl/kratos-transport/broker/sqs => ../../broker/sqs
...
require (
	...
	github.com/mimokpl/kratos-transport/broker/sqs v1.1.1
