...
func WithBlockCrypt(password, salt string) ServerOption {
	return func(s *Server) {
...
func WithDataShards(dataShards int) ServerOption {
	return func(s *Server) {
		s.dataShards = dataShards
	}
}

func WithParityShards(parityShards int) ServerOption {
	return func(s *Server) {
