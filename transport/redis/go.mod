module github.com/mimokpl/kratos-transport/transport/redis

go 1.25.0

replace (
	github.com/mimokpl/kratos-transport/broker => ../../broker
	github.com/mimokpl/kratos-transport/broker/redis => ../../broker/redis
...
require (
	...
	github.com/mimokpl/kratos-transport/broker/redis v1.3.3
