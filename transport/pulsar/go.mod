module github.com/mimokpl/kratos-transport/transport/pulsar

go 1.26.2

replace (
	github.com/mimokpl/kratos-transport/broker => ../../broker
	github.com/mimokpl/kratos-transport/broker/pulsar => ../../broker/pulsar
...
require (
	...
	github.com/mimokpl/kratos-transport/broker/pulsar v1.3.3
