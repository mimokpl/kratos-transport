module github.com/mimokpl/kratos-transport/transport/gcpubsub

go 1.25.0

replace (
	github.com/mimokpl/kratos-transport/broker => ../../broker
	github.com/mimokpl/kratos-transport/broker/gcpubsub => ../../broker/gcpubsub
...
require (
	...
	github.com/mimokpl/kratos-transport/broker/gcpubsub v1.3.1
