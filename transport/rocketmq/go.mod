module github.com/mimokpl/kratos-transport/transport/rocketmq

go 1.25.0

replace (
	github.com/mimokpl/kratos-transport/broker => ../../broker
	github.com/mimokpl/kratos-transport/broker/rocketmq => ../../broker/rocketmq
...
require (
	...
	github.com/mimokpl/kratos-transport/broker/rocketmq v1.3.3
