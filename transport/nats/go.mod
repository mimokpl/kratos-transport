module github.com/mimokpl/kratos-transport/transport/nats

go 1.25.0

replace (
	github.com/mimokpl/kratos-transport/broker => ../../broker
	github.com/mimokpl/kratos-transport/broker/nats => ../../broker/nats
...
require (
	...
	github.com/mimokpl/kratos-transport/broker/nats v1.1.1
